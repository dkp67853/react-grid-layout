...
export function calcGridItemPosition(
  ...
  const { margin, containerPadding, rowHeight, lockedRatio } = positionParams;
  ...
  if (lockedRatio) {
      ...
      out.width = calcGridItemWHPx(w, relativeColumnWidth, margin[0]);
      out.height = calcGridItemWHPx(h, relativeRowHeight, margin[1]);
    } else {
...
export function calcXY(
  ...
  const { margin, cols, rowHeight, maxRows, lockedRatio } = positionParams;
  const colWidth = calcGridColWidth(positionParams);
...
export function calcWH(
  ...
  const { margin, maxRows, cols, rowHeight, lockedRatio } = positionParams;
  const colWidth = calcGridColWidth(positionParams);
